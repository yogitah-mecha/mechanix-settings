...
class ManageNetworkAppBar extends StatelessWidget
    implements PreferredSizeWidget {
  final ScrollController breadcrumbController;

  const ManageNetworkAppBar({super.key, required this.breadcrumbController});
    ...
    return AppBar(
      ...
      title: AppBreadcrumbs(
        ...
        items: [
          ...
          BreadcrumbItem(label: AppLocalizations.of(context)!.manageWireless),
        ],
      ),
